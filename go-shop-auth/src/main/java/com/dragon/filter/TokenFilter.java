...
import com.dragon.realm.UserToken;
...
//                responseError(response, "token错误," + e.getMessage());
    ...
    protected boolean isLoginAttempt(ServletRequest request, ServletResponse response) {
        ...
        String STUDENT_Token = req.getHeader("STUDENT_Token");
        String TEACHER_Token = req.getHeader("TEACHER_Token");
        String ADMIN_Token = req.getHeader("ADMIN_Token");
        return StringUtils.isNotBlank(STUDENT_Token) || StringUtils.isNotBlank(TEACHER_Token) || StringUtils.isNotBlank(ADMIN_Token);
    }
